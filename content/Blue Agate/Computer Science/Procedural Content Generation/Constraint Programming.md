Constraint programming is a way of instructing computers, you enter  rigorously definided problem, and then the compute uses built in algorithms to find the solution.
